...
class Sigmoid(Transform):
    def __init__(self, temperature=1, eps=1e-6, device='cpu', learn_temperature=False):
        super().__init__()
        self.eps = eps
        self.device = device
...
class Logit(InverseTransform):
    def __init__(self, device='cpu', temperature=1, eps=1e-6):
        super().__init__(Sigmoid(device=device, temperature=temperature, eps=eps))
